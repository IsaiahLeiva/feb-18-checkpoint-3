...
export class Task {
    constructor(data) {
        ...
        this.name = data.name
        // NOTE you're going about this the wrong way. You need to keep track of wether or not a task is complete... think true or false
        this.checkbox = data.checkbox || false
        // NOTE each task will need a listId to tell the task which list it belnogs on
    }
